export default Sidebar = [
  {
    ...
    items: [
      ...
      {
        text: "026 - Remove Duplicates from Sorted Array",
      ...
      {
        text: "098 - Validate Binary Search Tree",
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: "516 - Longest Palindromic Subsequence",
      ...
      {
        text: "543 - Diameter of Binary Tree",
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: "1092 - Shortest Common Supersequence",
  ...
  },
  {
    ...
    items: [
      {
        text: "1232 - Check If It Is a Straight Line",
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: "1491 - Average Salary Excluding the Minimum and Maximum Salary",
        link: "/solution/1401-1500/1491 - Average Salary Excluding the Minimum and Maximum Salary.md",
      },
      {
        text: "1498 - Number of Subsequences That Satisfy the Given Sum Condition",
